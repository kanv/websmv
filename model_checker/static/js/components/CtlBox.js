...
export class CtlBox extends React.Component {

    constructor(props) {
        super(props);
        this.selected = '';
        this.binary = ['and', 'or', 'not', '()', '->', '<->'];
        this.ctl = ['AX','AF','AG','AU','EX','EF','EG','EU'];
        this.addState = this.addState.bind(this);
        this.changeFormula = this.changeFormula.bind(this);
        this.onAppend = this.onAppend.bind(this);
        this.changeState = this.changeState.bind(this);
        this.addCtl = this.addCtl.bind(this);
    }
	...
	render() {
		...
		return (
			<div className="tl-box">
                ...
                <div className="ctl-operators-box">
                    {
                        _this.ctl.map((b) => {
                            return (
                ...
                <button className="btn-add-tl-expr" onClick={this.addCtl}>
                    Add
                </button>
            </div>
		);
	...
	addCtl(){
	    this.props.addCtl(this.props.formula);
